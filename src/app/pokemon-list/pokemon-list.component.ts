...
export class PokemonListComponent implements OnInit {
  private _pokemonItemsSubject: BehaviorSubject<PokemonListItem[]> =
    new BehaviorSubject<PokemonListItem[]>([]);
  pokemonItems: Observable<PokemonListItem[]> =
    this._pokemonItemsSubject.asObservable();

  private _isListLoadingSubject: BehaviorSubject<boolean> =
    new BehaviorSubject<boolean>(true);
  isListLoading: Observable<boolean> =
    this._isListLoadingSubject.asObservable();
  ...
  private _handleResponse(
    ...
    instance._pokemonItemsSubject.next(
      response.results.map((res) => {
        ...
        instance._pokemonApiService
          .getPokemonDataFromUrl<IPokemonDetail>(res.url)
  ...
  getFirstPage() {
    this._pokemonApiService
      .getFirstPage(environment.pokemonPerListPage)
  ...
  getNextPage() {
    ...
    this._pokemonApiService
      .getNextPage(environment.pokemonPerListPage)
      .subscribe(this.reponseObserver);
  }
  ...
  getPrevPage() {
    ...
    this._pokemonApiService
      .getPrevPage(environment.pokemonPerListPage)
      .subscribe(this.reponseObserver);
  }
}
